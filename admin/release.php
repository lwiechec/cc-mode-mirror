...
<p>The current release is 5.34. <a
...
<p>See the list of <a href="changes-534.php">user visible changes</a>
since 5.33 and earlier versions, and the <a
href="src/ChangeLog">ChangeLog file</a> for details about the bugs
fixed in any patch releases made since the first 5.34 release.
